...
- **Servicios Externos**: Google Books API (metadatos bibliográficos e ISBN)
...
4. Pega el script SQL del archivo [`src/lib/sqlScripts.ts`](src/lib/sqlScripts.ts) (también disponible en la pestaña **"Ver Código & SQL"** dentro de la app) y haz clic en **Run**.
