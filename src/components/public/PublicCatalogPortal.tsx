  ...
  return (
    <div className="min-h-screen bg-slate-100/80 text-slate-800 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 rounded-2xl bg-[#83B141] flex items-center justify-center shadow-md text-white shrink-0 ring-2 ring-[#83B141]/30">
                <Library className="w-6 h-6" strokeWidth={1.75} />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[11px] font-bold uppercase tracking-widest text-[#EFDA18]">
                    Colegio Integral El Manglar
                  </span>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#83B141]/20 text-[#83B141] font-bold border border-[#83B141]/30">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3.5 py-2 bg-amber-600 hover:bg-amber-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-sm transition cursor-pointer"
              ...
              <button
                ...
                className="px-3.5 py-2 bg-[#83B141] hover:bg-[#719b35] text-white rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-sm transition cursor-pointer"
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6">
        ...
        {/* Welcome Hero Banner */}
        <div className="bg-white rounded-3xl p-6 sm:p-8 text-neutral-900 shadow-xs border border-[#D3D2D3] relative overflow-hidden">
          <div className="relative z-10 max-w-3xl space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#83B141]/10 border border-[#83B141]/30 text-[#83B141] text-xs font-bold">
        ...
        {shelves.length > 0 && (
          <div className="bg-white p-4 rounded-2xl border border-[#D3D2D3] shadow-xs space-y-2.5">
            <div className="flex items-center gap-2 text-xs font-bold text-neutral-800">
              <Bookmark className="w-4 h-4 text-[#83B141]" strokeWidth={1.75} />
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl font-bold transition whitespace-nowrap cursor-pointer ${
                  selectedShelfId === 'all'
                    ...
                    : 'bg-[#F8F9F8] hover:bg-neutral-100 text-neutral-700 border border-[#D3D2D3]'
                }`}
              >
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl font-semibold transition whitespace-nowrap cursor-pointer flex items-center gap-1.5 ${
                    selectedShelfId === shelf.id
                      ? 'bg-[#83B141] text-white font-bold shadow-xs'
                      : 'bg-[#F8F9F8] hover:bg-neutral-100 text-neutral-700 border border-[#D3D2D3]'
                  }`}
                >
        ...
        <div className="flex items-center justify-between text-xs text-slate-600 px-1">
          ...
          <span className="text-[#83B141] font-semibold flex items-center gap-1">
        ...
        {loading ? (
          <div className="py-20 text-center space-y-3">
            <div className="w-8 h-8 border-3 border-[#83B141] border-t-transparent rounded-full animate-spin mx-auto" />
          ...
          <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 shadow-xs space-y-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#83B141] hover:bg-[#719b35] text-white font-bold rounded-xl text-xs transition cursor-pointer"
            >
              Restablecer Filtros
            </button>
          </div>
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95 duration-200 space-y-4">
            <div className="flex items-start justify-between gap-3 pb-3 border-b border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-[10px] font-bold font-mono text-neutral-900 bg-[#EFDA18] px-2 py-0.5 rounded border border-[#EFDA18]/40">
